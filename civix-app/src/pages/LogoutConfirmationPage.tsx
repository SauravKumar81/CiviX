      ...
      <div className="max-w-md w-full bg-white dark:bg-gray-900 rounded-[40px] border border-gray-100 dark:border-gray-800 p-10 shadow-2xl shadow-gray-200/50 dark:shadow-none text-center space-y-8 transition-colors">
        ...
        <div className="space-y-4 pt-4">
          <button 
            ...
            className="w-full h-16 bg-red-500 hover:bg-red-600 text-white font-black rounded-2xl shadow-xl shadow-red-500/20 flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
            YES, LOG ME OUT
